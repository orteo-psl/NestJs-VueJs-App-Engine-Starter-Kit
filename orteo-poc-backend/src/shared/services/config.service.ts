    ...
    get typeOrmConfig(): TypeOrmModuleOptions {
        ...
        return {
            ...
            replication: {
                ...
                slaves: [
                    {
                        host: this.get('REPLICA_POSTGRES_HOST'),
                        port: this.getNumber('REPLICA_POSTGRES_PORT'),
                        username: this.get('REPLICA_POSTGRES_USERNAME'),
                        password: this.get('REPLICA_POSTGRES_PASSWORD'),
                        database: this.get('REPLICA_POSTGRES_DATABASE'),
                    }
                ]
            },
            migrationsRun: true,
